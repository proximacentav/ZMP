...
const Tr kTable[] = {
    ...
    {"Аудиодвижок BASS (libbass.so)", "BASS audio engine (libbass.so)", "BASS-Audioengine (libbass.so)"},
    {"Эффекты для BASS (libbass_fx.so)", "Effects for BASS (libbass_fx.so)", "Effekte für BASS (libbass_fx.so)"},
