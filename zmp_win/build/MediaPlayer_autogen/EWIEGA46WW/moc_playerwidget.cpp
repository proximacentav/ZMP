...
template <> constexpr inline auto PlayerWidget::qt_create_metaobjectdata<qt_meta_tag_ZN12PlayerWidgetE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'updateSpectrum'
        QtMocHelpers::SlotData<void(const QVector<float> &)>(4, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 5, 6 },
        }}),
        // Slot 'setAccentColor'
...
void PlayerWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->setMetadataHeight((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
        case 1: _t->updateSpectrum((*reinterpret_cast<std::add_pointer_t<QList<float>>>(_a[1]))); break;
        case 2: _t->setAccentColor((*reinterpret_cast<std::add_pointer_t<QColor>>(_a[1]))); break;
        ...
        case 5: _t->onStateChanged((*reinterpret_cast<std::add_pointer_t<bool>>(_a[1]))); break;
        case 6: _t->onSliderMoved((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
        case 7: _t->onPlaylistItemDoubleClicked((*reinterpret_cast<std::add_pointer_t<QListWidgetItem*>>(_a[1]))); break;
        default: ;
        }
    }
