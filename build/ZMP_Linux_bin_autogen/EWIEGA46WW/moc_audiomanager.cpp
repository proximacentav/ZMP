...
void AudioManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 8: _t->updateSpectrum(); break;
        case 9: _t->setSpectrumFps((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
        default: ;
        }
    }
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        if (QtMocHelpers::indexOfMethod<void (AudioManager::*)()>(_a, &AudioManager::trackEnded, 5))
            return;
        if (QtMocHelpers::indexOfMethod<void (AudioManager::*)(double )>(_a, &AudioManager::volumeChanged, 6))
            return;
    }
}
...
// SIGNAL 5
void AudioManager::trackEnded()
{
    QMetaObject::activate(this, &staticMetaObject, 5, nullptr);
}

// SIGNAL 6
void AudioManager::volumeChanged(double _t1)
{
